console.log("One more exercise and then we will be finished with this cursed chapter!")
let customers = [
    {
        "location": {
...
customers.forEach(customer => {
    console.log("ARRAY LENGTH", customer.contacts["email"].length)
    for (let i = 0; i < customer.contacts["email"].length; i++)
        emailArray.push(customer.contacts["email"][i])
})
